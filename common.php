...
function ewww_image_optimizer_options( $network = 'singlesite' ) {
	...
	$output[] = '<p>' . esc_html__( 'Troubleshooting: If you experience any problems with Easy Mode, disable Lazy Load and Include All Resources. Finally, disable Easy IO if problems remain.', 'ewww-image-optimizer-cloud' ) . "<br>\n" .
	...
	$output[] = "<tr class='$network_class'><th scope='row'><label for='ewww_image_optimizer_backup_files'>" . esc_html__( 'Include All Resources', 'ewww-image-optimizer-cloud' ) . '</label>' . ewwwio_help_link( 'https://docs.ewww.io/article/47-getting-more-from-exactdn', '59de6631042863379ddc953c' ) . '</th>' .
		...
		( ewww_image_optimizer_get_option( 'exactdn_all_the_things' ) ? "checked='true'" : '' ) . '> ' . esc_html__( 'Use Easy IO for all resources in wp-includes/ and wp-content/, including JavaScript, CSS, fonts, etc.', 'ewww-image-optimizer-cloud' ) . "</td></tr>\n";
	...
	$output[] = "<tr class='$network_class'><th scope='row'><label for='ewww_image_optimizer_lazy_load'>" . esc_html__( 'Lazy Load', 'ewww-image-optimizer-cloud' ) . '</label>' .
		...
		"<label for='ewww_image_optimizer_use_lqip'>" . esc_html__( 'Use low-quality versions of your images as placeholders (LQIP) via Easy IO. Can improve user experience, but may be slower than blank placeholders.', 'ewww-image-optimizer-cloud' ) . '</label>' .
	...
	$output[] = "<!--<div id='ewww-container-right' style='border: 1px solid #e5e5e5; float: right; margin-left: -215px; padding: 0em 1.5em 1em; background-color: #fff; box-shadow: 0 1px 1px rgba(0, 0, 0, 0.04); display: inline-block; width: 174px;'>\n" .
		...
		'<p><b>' . esc_html_x( 'CDN:', 'abbreviation for Content Delivery Network', 'ewww-image-optimizer-cloud' ) . "</b><br><a target='_blank' href='https://ewww.io/resize/'>" . esc_html__( 'Add Easy IO to increase website speeds dramatically!', 'ewww-image-optimizer-cloud' ) . "</a></p>\n" .
		"</div>-->\n" .
		"</div>\n";
