...
function ewww_image_optimizer_options( $network = 'singlesite' ) {
	...
	if ( ! ewww_image_optimizer_ce_webp_enabled() ) {
		...
		$output[] = "<tr class='$network_class'><th scope='row'><label for='ewww_image_optimizer_webp_for_cdn'>" .
			...
			( ewww_image_optimizer_get_option( 'ewww_image_optimizer_exactdn' ) ? esc_html( 'Enables automatic WebP conversion with ExactDN.', 'ewww-image-optimizer-cloud' ) : esc_html__( 'Use this if the Apache rewrite rules do not work, or if your images are served from a CDN.', 'ewww-image-optimizer-cloud' ) ) . ' ' .
