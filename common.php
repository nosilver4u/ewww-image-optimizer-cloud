...
function ewww_image_optimizer_options( $network = 'singlesite' ) {
	...
	if ( ewww_image_optimizer_get_option( 'ewww_image_optimizer_cloud_key' ) ) {
		...
		" <a href='https://ewww.io/free-trial/?TB_iframe=true&width=600&height=600' class='thickbox' target='_blank'>" . esc_html__( 'Get a free trial key.', 'ewww-image-optimizer-cloud' ) . "</a></td></tr>\n";
	}
	...
	$output[] = "<tr class='$network_class'><th>&nbsp;</th><td>" .
		...
		" <a href='https://ewww.io/free-trial/?TB_iframe=true&width=600&height=600' class='thickbox' target='_blank'>" . esc_html__( 'Or get a free trial key and take it for a test drive.', 'ewww-image-optimizer-cloud' ) . "</a></p>\n" :
	...
	echo '<hr><div id="ewwwio-banner"><img src="' . esc_url( plugins_url( '/images/ewwwio-logo.png', __FILE__ ) ) . '">' .
		...
		'<a href="https://ewww.io/connect/?TB_iframe=true&width=600&height=600" class="thickbox button-secondary">' . esc_html__( 'Subscribe at ewww.io', 'ewww-image-optimizer-cloud' ) . ' &rarr;</a></div>';
	...
	echo '<h3>' . esc_html__( 'Hosting', 'ewww-image-optimizer-cloud' ) . '</h3>' .
		...
		'<br><a href="https://vrlps.co/kXJu5yF/cp">Cloudways</a>* - ' .
			esc_html__( 'This is managed VPS hosting (not limited to WordPress), and they do a good job of keeping it pretty simple. I use their hosting for a few client sites and performance is crazy fast. Support has been great any time I\'ve needed their assistance.', 'ewww-image-optimizer-cloud' ) .
		'</p>' .
