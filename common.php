	...
	<?php if ( 1 === $wizard_step ) : ?>
		<?php if ( $display_exec_notice ) : ?>
			<div id='ewww-image-optimizer-warning-exec' class='ewwwio-notice notice-warning'>
				<?php esc_html_e( 'Sites where the exec() function is disabled require cloud-based optimization, because free server-based optimization will not work. However, we are trying something new, and offering free cloud-based JPG-only compression.', 'ewww-image-optimizer-cloud' ); ?>
				<br>
				<strong>
					<?php esc_html_e( 'You may ask your system administrator to enable exec() for free server-based optimization. Otherwise, continue to select free or paid mode below.', 'ewww-image-optimizer-cloud' ); ?>
