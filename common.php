...
function ewww_image_optimizer_options( $network = 'singlesite' ) {
	...
	if ( ! ewww_image_optimizer_get_option( 'ewww_image_optimizer_cloud_key' ) && ! ewww_image_optimizer_get_option( 'ewww_image_optimizer_exactdn' ) ) {
		$status_notices .= "<h3><a href='https://ewww.io/plans/' target='_blank' style='text-decoration:none;color:#3eadc9;'>" . esc_html__( 'Premium Upgrades with Priority Support:', 'ewww-image-optimizer-cloud' ) . "</a></h3>\n";
	}
	if ( ewww_image_optimizer_get_option( 'ewww_image_optimizer_cloud_key' ) ) {
		...
		$status_notices .= '<p><b>Compress API:</b> <a href="https://ewww.io/buy-credits/" target="_blank">' . esc_html__( 'Unlock premium compression, save storage space, and reduce server load.', 'ewww-image-optimizer-cloud' ) . '</a></p>';
		delete_option( 'ewww_image_optimizer_cloud_key_invalid' );
	...
	if ( class_exists( 'Jetpack_Photon' ) && Jetpack::is_module_active( 'photon' ) && ewww_image_optimizer_get_option( 'ewww_image_optimizer_exactdn' ) ) {
		...
		$status_notices          .= '<p><b>Easy IO:</b> <a href="https://ewww.io/resize/" target="_blank">' . esc_html__( 'Comprehensive image optimization with automatic compression, scaling, WebP conversion, and lazy load.', 'ewww-image-optimizer-cloud' ) . '</a></p>';
	...
	if ( defined( 'EWWW_DISABLE_ASYNC' ) && EWWW_DISABLE_ASYNC ) {
		...
		$status_notices .= '<span style="color: #3eadc9; font-weight: bolder">' . esc_html__( 'Enabled', 'ewww-image-optimizer-cloud' ) . '</span>';
	}
	$status_notices .= "</p>\n";
