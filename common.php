...
<div id='ewww-settings-wrap' class='wrap'>
	...
	<?php if ( 1 === $wizard_step ) : ?>
			<form id='ewwwio-wizard-step-1' class='ewwwio-wizard-form' method='post' action=''>
				...
				<h2><?php esc_html_e( 'In order to recommend the best settings for your site, please select which goal(s) are most important:', 'ewww-image-optimizer-cloud' ); ?></h2>
				...
				<div class='ewwwio-wizard-form-group'>
					...
					<label for='ewww_image_optimizer_budget_pay'><?php esc_html_e( 'Get 5x more optimization', 'ewww-image-optimizer-cloud' ); ?></label><br>
	...
	<?php elseif ( 2 === $wizard_step ) : ?>
			<form id='ewwwio-wizard-step-2' class='ewwwio-wizard-form' method='post' action=''>
				...
				<?php wp_nonce_field( 'ewww_image_optimizer_wizard' ); ?>
				<h2><?php esc_html_e( 'Here are the recommended settings for your site. Please review and then save the settings.', 'ewww-image-optimizer-cloud' ); ?></h2>
				<p>
		...
		<?php if ( ! $no_tracking ) : ?>
				<p>
					...
					<label for='ewww_image_optimizer_allow_tracking'><?php esc_html_e( 'Anonymous Reporting', 'ewww-image-optimizer-cloud' ); ?></label><br>
...
<div id='ewww-settings-wrap' class='wrap'>
	...
	<?php else : ?>
		...
		<?php endif; ?>
							...
							<p><strong><?php esc_html_e( 'Optimization Score', 'ewww-image-optimizer-cloud' ); ?></strong></p>
		<?php if ( $speed_score < 100 ) : ?>
							<p class="description"><?php esc_html_e( 'View recommendations', 'ewww-image-optimizer-cloud' ); ?></p>
		<?php endif; ?>
	...
	<?php else : ?>
			<p>
				...
				<?php printf( esc_html__( 'Switch to %s.', 'ewww-image-optimizer-cloud' ), '<a href="' . esc_url( wp_nonce_url( admin_url( 'options-general.php?page=ewww-image-optimizer-options&enable-local=0' ), 'ewww_image_optimizer_options-options' ) ) . '">' . esc_html__( 'Easy Mode', 'ewww-image-optimizer-cloud' ) . '</a>' ); ?>
			</p>
	<?php endif; ?>
			<p>
				<a href='<?php echo esc_url( wp_nonce_url( admin_url( 'options-general.php?page=ewww-image-optimizer-options&uncomplete_wizard=1' ), 'ewww_image_optimizer_options-options' ) ); ?>'>
					<?php esc_html_e( 'Reset Wizard', 'ewww-image-optimizer-cloud' ); ?>
				</a>
			</p>
	<?php ob_start(); ?>
		...
		<?php if ( ! $exactdn_enabled ) : ?>
				<tr>
					...
					<td>
						...
						<label for='ewww_image_optimizer_budget_pay'><?php esc_html_e( 'Get 5x more optimization and priority support with Easy IO and/or the Compress API', 'ewww-image-optimizer-cloud' ); ?></label><br>
	...
	<?php if ( ! get_option( 'easyio_exactdn' ) ) : ?>
		...
		<?php else : ?>
			<?php if ( class_exists( 'Jetpack_Photon' ) && Jetpack::is_module_active( 'photon' ) ) : ?>
						<p><span style="color: red"><?php esc_html_e( 'Inactive, please disable the Image Performance option on the Jetpack Dashboard.', 'ewww-image-optimizer-cloud' ); ?></span></p>
	...
	<?php elseif ( 'valid' === get_option( 'swis_license_status' ) ) : ?>
				<tr id="swis_promo_container" class="ewwwio-premium-setup" <?php echo wp_kses_post( $premium_hide ); ?>>
					...
					<td>
						<a href='<?php echo esc_url( admin_url( 'options-general.php?page=swis-performance-options' ) ); ?>'><?php esc_html_e( 'Installed and activated.', 'ewww-image-optimizer-cloud' ); ?></a>
					</td>
				</tr>
	<?php endif; ?>
				<tr>
	...
	<?php elseif ( ! ewww_image_optimizer_easy_active() || ewww_image_optimizer_get_option( 'ewww_image_optimizer_webp' ) ) : ?>
		...
		<?php if ( ! $free_exec && ! ewww_image_optimizer_easy_active() ) : ?>
						<p id='ewwwio-webp-storage-warning'>
							<i><?php esc_html_e( 'Enabling WebP Conversion without Easy IO will increase your storage requirements. Do you want to continue?', 'ewww-image-optimizer-cloud' ); ?></i><br>
							<a id='ewwwio-cancel-webp' href='#'><?php esc_html_e( 'Nevermind', 'ewww-image-optimizer-cloud' ); ?></a><br>
							<a id='ewwwio-easyio-webp-info' href='#ewwwio-exactdn-anchor'><?php esc_html_e( 'Tell me more about Easy IO', 'ewww-image-optimizer-cloud' ); ?></a><br>
							<span id='ewwwio-confirm-webp' class='button-primary'><?php esc_html_e( 'Continue', 'ewww-image-optimizer-cloud' ); ?></span>
						</p>
						<p class='description'>
							...
							printf(
								...
								'<a href="' . esc_url( admin_url( 'upload.php?page=ewww-image-optimizer-bulk' ) ) . '">' . esc_html__( 'Bulk Optimizer', 'ewww-image-optimizer-cloud' ) . '</a>',
								'<a href="https://ewww.io/easy/">' . esc_html__( 'Easy IO', 'ewww-image-optimizer-cloud' ) . '</a>'
							);
							?>
						</p>
		<?php endif; ?>
...
<div id='ewww-settings-wrap' class='wrap'>
	...
	<?php endif; ?>
						...
						<a href="https://eepurl.com/gKyU6L?TB_iframe=true&width=600&height=610" class="thickbox button-secondary"><?php esc_html_e( 'Subscribe now!', 'ewww-image-optimizer-cloud' ); ?> &rarr;</a>
						<a target="_blank" href="https://wordpress.org/support/plugin/ewww-image-optimizer/reviews/#new-post" class="button-secondary"><?php // esc_html_e( ' Review', 'ewww-image-optimizer-cloud' ) . '</a>' . ?></a>
					</div>
				</div>
				<div class='inside'>
					<div class="ewww-row ewww-blocks">
	...
	<?php if ( 'singlesite' === $network && $easymode ) : ?>
			...
			<p><?php printf( esc_html__( 'If you need to save storage space, enable %s.', 'ewww-image-optimizer-cloud' ), '<a href="' . esc_url( wp_nonce_url( admin_url( 'options-general.php?page=ewww-image-optimizer-options&enable-local=1' ), 'ewww_image_optimizer_options-options' ) ) . '">' . esc_html__( ' Mode', 'ewww-image-optimizer-cloud' ) . '</a>' ); ?></p>
