...
function ewww_image_optimizer_options( $network = 'singlesite' ) {
	...
	if ( ( 'network-multisite' != $network || ! get_site_option( 'ewww_image_optimizer_allow_multisite_override' ) ) && // Display tabs so long as this isn't the network admin OR single-site override is disabled.
		...
		$output[] = "<ul class='ewww-tab-nav'>\n" .
			...
			"<li class='ewww-tab ewww-help-nav'><span class='ewww-tab-hidden'>" . esc_html__( 'Get Help', 'ewww-image-optimizer-cloud' ) . "</span></li>\n" .
			"<li class='ewww-tab ewww-support-nav'><span class='ewww-tab-hidden'>" . esc_html__( 'Support EWWW I.O.', 'ewww-image-optimizer-cloud' ) . "</span></li>\n" .
		"</ul>\n";
	}
	if ( 'network-multisite' == $network ) {
	...
	$output[] = "<tr class='$network_class'><th scope='row'><label for='ewww_image_optimizer_lazy_load'>" . esc_html__( 'Lazy Load', 'ewww-image-optimizer-cloud' ) . '</label>' . ewwwio_help_link( 'https://docs.ewww.io/article/74-lazy-load', '5c6c36ed042863543ccd2d9b' ) .
		...
		esc_html__( 'Improves actual and perceived loading time as images will be loaded only as they enter (or are about to enter) the viewport. Integration with the ExactDN and WebP features enables the plugin to load the best available image size and image format for each device.', 'ewww-image-optimizer-cloud' ) . "</td></tr>\n";
	...
	$output[] = '<p><strong>' . esc_html__( 'Would you like to support development of this plugin? Here are some ways you can contribute:', 'ewww-image-optimizer-cloud' ) . "</strong></p>\n";
