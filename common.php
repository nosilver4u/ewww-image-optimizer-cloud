...
function ewww_image_optimizer_ims() {
	...
	if ( empty( $_REQUEST['ewww_gid'] ) ) {
		...
		if ( ewww_image_optimizer_iterable( $galleries ) ) {
			...
			echo '<p>' . esc_html__( 'Choose a gallery or', 'ewww-image-optimizer-cloud' ) . ' <a href="' . esc_url( admin_url( "upload.php?page=ewww-image-optimizer-bulk&ids=$gallery_string" ) ) . '">' . esc_html__( 'optimize all galleries', 'ewww-image-optimizer-cloud' ) . '</a></p>';
			...
			foreach ( $galleries as $gid ) {
				...
				echo "<td><a href='" . esc_url( admin_url( "upload.php?page=ewww-image-optimizer-bulk&ids=$gid" ) ) . "'>" . esc_html__( 'Optimize Gallery', 'ewww-image-optimizer-cloud' ) . '</a></td></tr>';
			}
			echo '</table>';
		} else {
		...
		if ( ewww_image_optimizer_iterable( $attachments ) ) {
			echo "<p><a href='" . esc_url( admin_url( "upload.php?page=ewww-image-optimizer-bulk&ids=$gid" ) ) . "'>" . esc_html__( 'Optimize Gallery', 'ewww-image-optimizer-cloud' ) . '</a></p>';
...
function ewww_image_optimizer_options( $network = 'singlesite' ) {
	...
	if ( ewww_image_optimizer_get_option( 'ewww_image_optimizer_cloud_key' ) ) {
		...
		$output[] = "<tr class='$network_class'><th scope='row'><label for='ewww_image_optimizer_cloud_key'>" . esc_html__( 'Optimization API Key', 'ewww-image-optimizer-cloud' ) . '</label>' .
		...
		esc_html__( 'API Key will be validated when you save your settings.', 'ewww-image-optimizer-cloud' ) .
		" <a href='https://optimize.exactlywww.com/api_key/free-trial.php?TB_iframe=true&width=600&height=375' class='thickbox' target='_blank'>" . esc_html__( 'Get a free trial key.', 'ewww-image-optimizer-cloud' ) . "</a></td></tr>\n";
	}
	...
	$output[] = "<tr class='$network_class'><th>&nbsp;</th><td>" .
		( ! ewww_image_optimizer_get_option( 'ewww_image_optimizer_cloud_key' ) ? "<p class='$network_class nocloud'>* <strong><a href='https://ewww.io/buy-credits/' target='_blank'>" . esc_html__( 'Purchase an API key to unlock these optimization levels and get priority support. Achieve up to 80% compression to speed up your site, save storage space, and reduce server load.', 'ewww-image-optimizer-cloud' ) . '</a></strong><br>' .
		" <a href='https://optimize.exactlywww.com/api_key/free-trial.php?TB_iframe=true&width=600&height=375' class='thickbox' target='_blank'>" . esc_html__( 'Or get a free trial key and take it for a test drive.', 'ewww-image-optimizer-cloud' ) . "</a></p>\n" :
	...
	$output[]           = '<table id="ewww-settings-disable-resizes"><tr class="network-singlesite"><th scope="col">' . esc_html__( 'Disable Optimization', 'ewww-image-optimizer-cloud' ) . '</th><th scope="col">' . esc_html__( 'Disable Creation', 'ewww-image-optimizer-cloud' ) . "</th></tr>\n";
	...
	global $eio_debug;
	if ( ! empty( $eio_debug ) ) {
		$debug_output = '<p class="debug-actions"><b>' . esc_html__( 'Debugging Information', 'ewww-image-optimizer-cloud' ) . ':</b> <button id="ewww-copy-debug" class="button button-secondary" type="button">' . esc_html__( 'Copy', 'ewww-image-optimizer-cloud' ) . '</button>';
	...
	echo '<p>' . esc_html__( 'These are products I have personally used. An * indicates an affiliate link which allows you to support future development of EWWW IO.', 'ewww-image-optimizer-cloud' ) . '</p>';
