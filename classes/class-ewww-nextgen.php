		...
		function ewww_ngg_bulk_preview() {
			...
			<div class="wrap">
				...
				if ( ewww_image_optimizer_get_option( 'ewww_image_optimizer_cloud_key' ) ) {
					...
					echo '<a id="ewww-bulk-credits-available" target="_blank" class="page-title-action" style="float:right;" href="https://ewww.io/my-account/">' . esc_html__( 'Image credits available:', 'ewww-image-optimizer-cloud' ) . ' ' . wp_kses_post( ewww_image_optimizer_cloud_quota() ) . '</a>';
				}
