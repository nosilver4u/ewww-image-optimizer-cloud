...
function ewww_image_optimizer_display_tools() {
	...
	$output .= '<span class="total-pages"></span>' . "\n" .
		...
		"</div>\n";
	echo $output;
	echo "<div>\n<p id='ewww-clear-table-info' class='ewww-tool-info'>" . esc_html__( 'The optimization history prevents the plugin from re-optimizing images, but you may erase the history to reduce database size or to force the plugin to re-optimize all images.', 'ewww-image-optimizer-cloud' ) . "</p>\n";
